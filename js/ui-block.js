        ...
        function selectWalletFile(selector, callback) {
            ...
            i18n.run($(selector)
                ...
                .html(
                    ...
                    '<label class="hide pass"><span data-i18n=swf/good></span><input class="password" type=password></label>'
                    )
            ...
            function onChangeFile(e) {
                ...
                function onload(e) {
                    try {
                        ...
                        var $unlock = $(".btn-block");
                        if ($unlock.length) {$unlock.remove();}
                        $('<button class="btn btn-block" data-i18n="swf/unlock">Unlock</button>').insertBefore(".password");
                    } catch (e) {
